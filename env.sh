...
#
#+
if [ X/Applications/geant4.9.3 != X/Applications/geant4.9.3 ] ; then
G4INSTALL="/Applications/geant4.9.3/src/geant4"
else
G4INSTALL="/Applications/geant4.9.3"
fi
export G4INSTALL
if [ X$g4non_display = X ] ; then
...
if [ Xn != Xn ] ; then 
if [ X/Applications/geant4.9.3 != X/Applications/geant4.9.3 ] ; then
G4INCLUDE="/Applications/geant4.9.3/include/geant4"
else
G4INCLUDE="/Applications/geant4.9.3/include/"
fi
export G4INCLUDE
if [ X$g4non_display = X ] ; then
...
#else
#G4BASE="/Applications/geant4.9.3/include/geant4/source"
#export G4BASE
#if [ X$g4non_display = X ] ; then
...
#+
if [ X/Applications/geant4.9.3/lib != X ] ; then 
if [ X/Applications/geant4.9.3 != X/Applications/geant4.9.3 ] ; then
G4LIB="/Applications/geant4.9.3/lib/geant4"
else
G4LIB="/Applications/geant4.9.3/lib"
fi
export G4LIB
if [ X$g4non_display = X ] ; then
...
#+
if [ X/Applications/geant4.9.3/data/PhotonEvaporation2.0 != X ] ; then 
G4LEVELGAMMADATA="/Applications/geant4.9.3/data/PhotonEvaporation2.0"
...
#+
if [ X/Applications/geant4.9.3/data/RadioactiveDecay3.2 != X ] ; then 
G4RADIOACTIVEDATA="/Applications/geant4.9.3/data/RadioactiveDecay3.2"
...
#+
if [ X/Applications/geant4.9.3/data/G4EMLOW6.9 != X ] ; then 
G4LEDATA="/Applications/geant4.9.3/data/G4EMLOW6.9"
export G4LEDATA
if [ X$g4non_display = X ] ; then
...
#+
if [ X/Applications/geant4.9.3/data/G4NDL3.13 != X ] ; then 
G4NEUTRONHPDATA="/Applications/geant4.9.3/data/G4NDL3.13"
...
#+
if [ X/Applications/geant4.9.3/data/G4ABLA3.0 != X ] ; then 
G4ABLADATA="/Applications/geant4.9.3/data/G4ABLA3.0"
export G4ABLADATA
if [ X$g4non_display = X ] ; then
...
#+
if [ X/Applications/geant4.9.3/data/RealSurface1.0 != X ] ; then 
G4REALSURFACEDATA="/Applications/geant4.9.3/data/RealSurface1.0"
...
# g4clhep.U
#
if [ X/Applications/CLHEP != X ] ; then 
CLHEP_BASE_DIR="/Applications/CLHEP"
...
#+
if [ X/Applications/CLHEP/include != X ] ; then 
CLHEP_INCLUDE_DIR="/Applications/CLHEP/include"
...
#+
if [ X/Applications/CLHEP/lib != X ] ; then 
CLHEP_LIB_DIR="/Applications/CLHEP/lib"
